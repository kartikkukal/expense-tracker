...
class view_transaction:
    ...
    def run(self, id):
        ...
        record = self.root.mysql.get_transaction(id)
        ...
        self.note_entry = tk.StringVar(root_frame, value=record[2])
        ...
        self.amount_entry = tk.StringVar(root_frame, value=str(record[4]))
        ...
        self.category = tk.StringVar(value=self.categories[record[3] - 1])
        ...
        self.additional_entry = tk.StringVar(root_frame, value=record[5])
        ...
        ttk.Button(button_frame, text="Update", width=10, style="Accent.TButton").pack(side=tk.RIGHT, padx=(0, 10))
