...
class CreateCategory:
    ...
    def run(self):
        ...
        self.dialog.title("Create Category")
        ...
        ttk.Button(button_frame, text="Create", style="Accent.TButton", command=self.create_category).pack(side=tk.RIGHT, ipadx=15)
    ...
    def create_category(self):
        ...
        self.root.mysql.create_category(self.name_entry.get())
        self.root.event_category_update()
