...
class add_expense:
    ...
    def run(self):
        ...
        ttk.Button(button_frame, text="Create", width=10, style="Accent.TButton", command=self.add_expense).pack(side=tk.RIGHT, padx=(0, 10))
    ...
    def add_expense(self):
        ...
        self.root.mysql.add_expense(date_time, note, category, amount, additional)
